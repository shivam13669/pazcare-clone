...
const title = "360 Biz Health — Employee Insurance & Benefits Platform for India";
const description =
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <FeatureBlocks
          ...
          heading="Accessing employee benefits is now easy and straightforward with the 360 Biz Health app."
